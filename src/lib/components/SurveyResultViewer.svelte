...
<div class="flex flex-col bg-slate-100 rounded-xl dark:bg-amber-800 py-8 justify-center mb-4">
...
<div class="flex flex-col bg-slate-100 rounded-xl dark:bg-amber-800 py-4 justify-center mb-4">
...
{#each surveyResult.questions as question, i}
    <div class="flex flex-col bg-slate-100 rounded-xl dark:bg-amber-800 py-4 mb-4">
